package com.middleware.mw.aop;

import cn.hutool.core.collection.CollectionUtil;
import com.middleware.mw.param.BaseInput;
...
//    @Pointcut("args(middleware.mw.param.BaseInput)")
//    public void checkControllerInput(){
//    }

    @Pointcut("within(middleware.mw.web.*)")
    public void checkControllerInput2() {
    }

    @Pointcut("@annotation(com.middleware.mw.anotation.CheckInput)")
