package com.middleware.rabbitmq.workqueues;

import com.rabbitmq.client.*;
import com.middleware.rabbitmq.helloworld.HelloWorldPublisher;
...
public class WorkqueuesConsumer {
    ...
    public void consumer1() throws IOException, TimeoutException {
        ...
        channel.basicConsume(WorkqueuesPublisher.QUEUE_NAME,false,callback);
        System.in.read();
    }
